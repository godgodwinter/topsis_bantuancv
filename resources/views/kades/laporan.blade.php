...
@section('title','Laporan dan Verifikasi')
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                href="/kades/laporan/{{$data->id}}/verif"><span class="pcoded-micon"> <i
                                    ...
                                    <a href="{{ url('/')}}/kades/laporan/{{ $data->id }}/verifikasi" class="btn btn-warning"
                                    ...
                                    <a href="{{ url('/')}}/kades/laporan/{{ $data->id }}/verifikasibatalkan" class="btn btn-danger"
