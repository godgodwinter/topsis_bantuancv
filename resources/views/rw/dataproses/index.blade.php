...
<div class="page-body">
    ...
    <div class="card">
        <div class="cointainer"> 
            ...
            href="/rw/dataproses/{{ $th_penerimaan->id }}/kuota"><span class="pcoded-micon"> <i
            ...
            <a class="btn btn-success btn-outline-success"
                href="/rw/dataproses/{{ $th_penerimaan->id }}/addwarga"><span class="pcoded-micon"> <i
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="/rw/dataproses/isidata/add " method="post">
                            @csrf
