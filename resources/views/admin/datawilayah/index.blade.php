...
<div class="page-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                href="/admin/datawilayah/detail/{{$data->id}}"><span class="pcoded-micon"> <i
                                        class="feather icon-edit"></i>Detail</span></a>
                                <a class="btn btn-warning btn-outline-warning btn-sm"
                                    href="/admin/datawilayah/{{$data->id}}/edit"><span class="pcoded-micon"> <i
                                            class="feather icon-edit"></i></span></a>
                                <form action="/admin/datawilayah/{{$data->id}}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
    ...
    <div class="card">
        <div class="card-block">
            <div class="card-body">
                <form action="/admin/datawilayah " method="post">
                    @csrf
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama" id="input-nama"
                                        ...
                                        placeholder="Contoh : Dusun Krajan " value="{{old('nama')}}" required>
...
<!-- tambah end -->
    ...
    <div class="card">
        <div class="card-block">
            <div class="card-body">
                <form action="/admin/datawilayah/user" method="post">
                    @csrf
                    <h5>Tambah User @yield('title')</h5>
                    <span>&nbsp; </span>
                    <div class="pl-lg-4">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-6 col-xl-6 m-b-30">
                                <label class="form-control-label" for="input-status">Pilih Dusun (*</label>
                                <select name="dusun_id" id="input-status"
