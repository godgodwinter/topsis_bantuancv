                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-warning btn-outline-warning btn-sm"
                                    href="/admin/datawilayah/userrw/{{ $ds->id }}/{{ $rw->id }}/{{$data->id}}/edit"><span class="pcoded-micon"> <i
                                            class="feather icon-edit"></i></span></a>
                                <form action="/admin/datawilayah/userrw/{{ $ds->id }}/{{ $rw->id }}/{{$data->id}}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
