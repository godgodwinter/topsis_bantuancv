...
<div class="page-body">
    ...
    <div class="card">
        <div class="cointainer"> 
            ...
            href="/dusun/dataproses/{{ $th_penerimaan->id }}/kuota"><span class="pcoded-micon"> <i
            ...
            <a class="btn btn-success btn-outline-success"
                href="/dusun/dataproses/{{ $th_penerimaan->id }}/addwarga"><span class="pcoded-micon"> <i
                    ...
                    <tbody>
                        ...
                        $datwargas = DB::select('select * from data_warga where nik = ?', array($data_proses->nik));
                                    foreach ($datwargas as $ambildw) {
                                        ...
                                        $dusun_id=$ambildw->dusun_id;
                                        if($dusun_id===$dusunid_user){
                                            // dd($rw_id,$rwid_user,'true');
                                        ?>
...
<tr>
    <td>
            <button class="btn btn-danger btn-sm btn-outline-warning"
              ><span
                    class="pcoded-micon">  {{ ($loop->index)+1 }}</span></button>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="/dusun/dataproses/isidata/add " method="post">
                            @csrf
