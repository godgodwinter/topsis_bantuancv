...
6. Jika ingin menggunakan data palsu untuk testing lanjutkan langkah 6 ini
   ```sh
   php artisan db:seed --class=userseeder  //untuk meload data user admin@gmail.com pass 12345678 //untuk data kedes kades@gmail.com pass 12345678 //update revisi->>untuk load data wilayah juga dsni
   ```
   ...
   ```sh
   *************php artisan db:seed --class=Kriteriaseeder   //untuk meload data kriteria dan range nya ->>>update revisi jangan gunakan ini
   ```
